...
Read the following asset specification files from `{{workspace_dir}}/.devin/assets/` to understand documentation formats and guidelines before refining the plan:

- **Contexts:** [contexts.md]({{workspace_dir}}/.devin/assets/contexts.md) - domain language and terminology specification
